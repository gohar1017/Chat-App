...
const LoginPage = () => {
  ...
  return (
    ...
    justify-center gap-8 sm:justify-content max-sm:flex-col backdrop-blur-2xl">
      {/*-------------LEFT----------- */}
      ...
      p-6 flex flex-col gap-6 rounded-lg shadow-lg">
        <h2 className="flex-medium-text-2xl flex justify-between items-center">{currState}
          {
