...
const ChatContainer = () => {
 ...
 const handleSendMessge = async(event)=>{
    ...
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3">
        <div className="flex-1 flex items-center bg-gray-100/12 px-3 rounded-full">
          <input
            onChange={(e)=>setInput(e.target.value)} value = {input} onKeyDown={(e)=>e.key==="Enter"?handleSendMessge(e):null}
            type="text"
        ...
        <img onClick = {handleSendMessge}src={assets.send_button} alt="" className="w-7 cursor-pointer" />
      </div>
    </div>
  ) : (
    <div
